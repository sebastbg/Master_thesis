program yield_surface_full
    ...
    params(4) = 50          ! Exponent in the RSCYF - Regularized Single Crystal Yield Function
    ...
    do a1=1,100! !Alpha 1 loop
        ...
        do a2=1,100! !alpha2 loop
            ...
            do n=1,100!0!10 
                ...
                do i =1,12
                   cs10 = cs10 + gm_temp(i) + gm_temp(i+48)
                end do
                
                do i =13,24
                   cs20 = cs20 + gm_temp(i) + gm_temp(i+48)
                end do
                
                do i =25,48
                   cs30 = cs30 + gm_temp(i) + gm_temp(i+48)
                end do
